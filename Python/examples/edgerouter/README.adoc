...
Further information on load-balancing is available in the link:https://help.ui.com/hc/en-us/articles/205145990-EdgeRouter-WAN-Load-Balancing[Ubiquiti(R) EdgeRouter WAN Load-Balancing documentation].
